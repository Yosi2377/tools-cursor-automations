...
const TableFelt: React.FC = () => {
  return (
    <>
      ...
      {/* Dark leather trim */}
      <div className="absolute inset-1 rounded-[115px] bg-[#141414]" />
      
      {/* Golden trim */}
      <div className="absolute inset-2 rounded-[110px] bg-[#FCD34D]" />
      
      {/* Green felt */}
      <div className="absolute inset-4 rounded-[100px] bg-[#059669] overflow-hidden">
