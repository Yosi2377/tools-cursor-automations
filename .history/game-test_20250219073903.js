...
async function runTest() {
  ...
  await page.addStyleTag({
    content: `
      ...
      .player-position:nth-child(1), [class*="player-position"]:nth-child(1) { top: 5%; left: 50%; }
      .player-position:nth-child(2), [class*="player-position"]:nth-child(2) { top: 20%; left: 85%; }
      .player-position:nth-child(3), [class*="player-position"]:nth-child(3) { top: 50%; left: 95%; }
      .player-position:nth-child(4), [class*="player-position"]:nth-child(4) { top: 80%; left: 85%; }
      .player-position:nth-child(5), [class*="player-position"]:nth-child(5) { top: 95%; left: 50%; }
      .player-position:nth-child(6), [class*="player-position"]:nth-child(6) { top: 80%; left: 15%; }
      .player-position:nth-child(7), [class*="player-position"]:nth-child(7) { top: 50%; left: 5%; }
      .player-position:nth-child(8), [class*="player-position"]:nth-child(8) { top: 20%; left: 15%; }
      ...
      .pot { top: 40%; left: 50%; transform: translate(-50%, -50%); }
      .bet-amount { bottom: -20px; left: 50%; transform: translateX(-50%); }
      .player-name { top: -20px; left: 50%; transform: translateX(-50%); }
    `
  });
