  ...
  try {
    ...
    while (monitoringTime < TOTAL_MONITORING_TIME) {
      ...
      if (gameState) {
        ...
        // Enhanced stuck game detection
        const isStuck = (
          (gameState.playersActed === 0 && monitoringTime > 30000) || // No players acted for 30 seconds
          (waitingForFlop && monitoringTime > 60000) || // Waiting for flop for more than 60 seconds
          (gameState.phase === 'Not found' && monitoringTime > 15000) // Game phase not found for 15 seconds
        );
