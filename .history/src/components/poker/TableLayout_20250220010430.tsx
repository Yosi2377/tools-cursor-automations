...
const TableLayout: React.FC<TableLayoutProps> = ({ gameContext, onTimeout }) => {
  ...
  const getSpotPosition = (position: string) => {
    switch (position) {
      ...
      case 'bottomRight':
        return 'bottom-[45%] right-[25%] translate-x-0';
      case 'right':
        return 'top-1/2 right-[25%] -translate-y-1/2 translate-x-0';
      case 'topRight':
        return 'top-[45%] right-[25%] translate-x-0';
      case 'top':
        return 'top-[25%] left-1/2 -translate-x-1/2';
      case 'topLeft':
        return 'top-[45%] left-[25%] translate-x-0';
      case 'left':
        return 'top-1/2 left-[25%] -translate-y-1/2 translate-x-0';
      case 'bottomLeft':
        return 'bottom-[45%] left-[25%] translate-x-0';
      default:
        return '';
    }
  };
