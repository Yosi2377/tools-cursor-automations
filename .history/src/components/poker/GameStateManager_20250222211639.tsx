      ...
      .on(
        ...
        (payload) => {
            ...
            updatedPlayers = prev.players.map(p => 
              p.position === updatedPlayer.position
                ? {
                    ...
                    currentBet: updatedPlayer.current_bet,
                    isTurn: updatedPlayer.is_turn,
                    name: updatedPlayer.user_id ? `Player ${updatedPlayer.id.slice(0, 4)}` : `Bot ${updatedPlayer.id.slice(0, 4)}`,
                    isVisible: true,
          ...
          console.log('Updated player data:', {
            players: updatedPlayers,
            totalPot: updatedPlayers.reduce((sum, player) => sum + (player.currentBet || 0), 0),
