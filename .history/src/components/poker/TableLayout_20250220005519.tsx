...
const TableLayout: React.FC<TableLayoutProps> = ({ gameContext, onTimeout }) => {
  ...
  const getSpotPosition = (position: string) => {
    switch (position) {
      ...
      case 'bottomRight':
        return 'bottom-[25%] right-[8%] translate-x-0';
      case 'right':
        return 'top-1/2 right-[8%] -translate-y-1/2 translate-x-0';
      case 'topRight':
        return 'top-[25%] right-[8%] translate-x-0';
      case 'top':
        return 'top-[8%] left-1/2 -translate-x-1/2';
      case 'topLeft':
        return 'top-[25%] left-[8%] -translate-x-0';
      case 'left':
        return 'left-[8%] top-1/2 -translate-y-1/2 -translate-x-0';
      case 'bottomLeft':
        return 'bottom-[25%] left-[8%] -translate-x-0';
      default:
        return '';
    }
  };
