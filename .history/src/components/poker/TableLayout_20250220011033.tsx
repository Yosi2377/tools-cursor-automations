...
const TableLayout: React.FC<TableLayoutProps> = ({ gameContext, onTimeout }) => {
  ...
  const getPlayerPosition = (position: PlayerPosition) => {
    switch (position) {
      case 'bottom':
        return 'bottom-[45%] left-1/2 -translate-x-1/2';
      case 'bottomRight':
        return 'bottom-[65%] right-[45%] translate-x-0';
      case 'right':
        return 'top-1/2 right-[45%] -translate-y-1/2 translate-x-0';
      case 'topRight':
        return 'top-[65%] right-[45%] translate-x-0';
      case 'top':
        return 'top-[45%] left-1/2 -translate-x-1/2';
      case 'topLeft':
        return 'top-[65%] left-[45%] translate-x-0';
      case 'left':
        return 'top-1/2 left-[45%] -translate-y-1/2 translate-x-0';
      case 'bottomLeft':
        return 'bottom-[65%] left-[45%] translate-x-0';
      default:
        return '';
    }
  };
