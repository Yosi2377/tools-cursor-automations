      ...
      .on(
        ...
        (payload) => {
          console.log('Player update payload:', {
            ...
            chips: payload.new.chips,
            cards: payload.new.cards,
            isActive: payload.new.is_active,
            currentBet: payload.new.current_bet,
            isTurn: payload.new.is_turn,
          ...
          console.log('Updated player data:', updatedPlayers);
        }
      )
      .subscribe();
