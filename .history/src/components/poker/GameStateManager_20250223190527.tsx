...
// Ensure handleOpponentAction is defined or imported
...
export const useGameState = (roomId: string) => {
  ...
  }, [gameContext.players, dealNextCommunityCards, setGameContext]);
  ...
  useEffect(() => {
    checkGameState();
  }, [checkGameState, gameContext.players, gameContext.currentBet]);
