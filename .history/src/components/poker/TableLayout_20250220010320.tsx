...
const TableLayout: React.FC<TableLayoutProps> = ({ gameContext, onTimeout }) => {
  ...
  const getSpotPosition = (position: string) => {
    switch (position) {
      ...
      case 'bottomRight':
        return 'bottom-[40%] right-[20%] translate-x-0';
      case 'right':
        return 'top-1/2 right-[20%] -translate-y-1/2 translate-x-0';
      case 'topRight':
        return 'top-[40%] right-[20%] translate-x-0';
      case 'top':
        return 'top-[20%] left-1/2 -translate-x-1/2';
      case 'topLeft':
        return 'top-[40%] left-[20%] -translate-x-0';
      case 'left':
        return 'left-[20%] top-1/2 -translate-y-1/2 -translate-x-0';
      case 'bottomLeft':
        return 'bottom-[40%] left-[20%] -translate-x-0';
      default:
        return '';
    }
  };
