...
const TableLayout: React.FC<TableLayoutProps> = ({ gameContext, onTimeout }) => {
  ...
  const getSpotPosition = (position: string) => {
    switch (position) {
      ...
      case 'bottomRight':
        return 'bottom-[30%] right-[10%] translate-x-0';
      case 'right':
        return 'top-1/2 right-[10%] -translate-y-1/2 translate-x-0';
      case 'topRight':
        return 'top-[30%] right-[10%] translate-x-0';
      case 'top':
        return 'top-[12%] left-1/2 -translate-x-1/2';
      case 'topLeft':
        return 'top-[30%] left-[10%] -translate-x-0';
      case 'left':
        return 'left-[10%] top-1/2 -translate-y-1/2 -translate-x-0';
      case 'bottomLeft':
        return 'bottom-[30%] left-[10%] -translate-x-0';
      default:
        return '';
    }
  };
