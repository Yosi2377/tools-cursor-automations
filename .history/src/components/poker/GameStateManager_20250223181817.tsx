  ...
  useEffect(() => {
    const initializeGame = async () => {
      try {
        ...
        // Set initial game context with game ID
        setGameContext(prev => ({
          ...prev,
          gameId: game.id,
        ...
        console.log('Game context initialized with ID:', game.id);
        ...
        (payload) => {
          ...
          setGameContext(prev => {
            ...
            return {
              ...
              communityCards: newGameState.community_cards ? JSON.parse(newGameState.community_cards as string) : [],
