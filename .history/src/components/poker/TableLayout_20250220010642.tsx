...
const TableLayout: React.FC<TableLayoutProps> = ({ gameContext, onTimeout }) => {
  ...
  const getPlayerPosition = (position: PlayerPosition): string => {
    switch (position) {
      ...
      case 'bottomRight':
        return 'bottom-[50%] right-[30%] translate-x-0'
      case 'right':
        return 'top-1/2 right-[30%] -translate-y-1/2 translate-x-0'
      case 'topRight':
        return 'top-[50%] right-[30%] translate-x-0'
      case 'top':
        return 'top-[30%] left-1/2 -translate-x-1/2'
      case 'topLeft':
        return 'top-[50%] left-[30%] translate-x-0'
      case 'left':
        return 'top-1/2 left-[30%] -translate-y-1/2 translate-x-0'
      case 'bottomLeft':
        return 'bottom-[50%] left-[30%] translate-x-0'
      default:
        return ''
    }
  };
